...
public class BlogDataGenerator {
    ...
    public static void main(String[] args) {
        ...
        // Get users to assign as blog creators
        List<User> users = userService.getAllUsers();
        if (users.isEmpty()) {
            System.out.println("No users found. Please run UserDataGenerator first.");
            return;
        }
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // Randomly select a user as the creator
            ...
            System.out.println("Created blog entry: " + title + " by " + creator.getFirstname() + " " + creator.getLastname());
        }
